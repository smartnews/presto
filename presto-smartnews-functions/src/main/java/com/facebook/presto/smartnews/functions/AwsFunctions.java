...
public final class AwsFunctions
{
    ...
    static {
        ...
        TABLE_CACHE = CacheBuilder.newBuilder()
                ...
                {
                    @Override
                    public Table load(String tbl) throws Exception
                    {
    ...
    {
        return ddbGet(tbl,
                new KeyAttribute(hashKeyName.toStringUtf8(), new Long(hashKeyValue)));
    }
                               ...
                               @SqlType(StandardTypes.BIGINT) long rangeKeyValue)
    {
        return ddbGet(tbl,
                new KeyAttribute(hashKeyName.toStringUtf8(), hashKeyValue.toStringUtf8()),
                new KeyAttribute(rangeKeyName.toStringUtf8(), new Long(rangeKeyValue))
        );
    }

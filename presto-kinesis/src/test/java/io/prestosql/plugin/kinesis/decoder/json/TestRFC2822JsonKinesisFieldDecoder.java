...
import static io.prestosql.plugin.kinesis.decoder.KinesisFieldDecoder.DEFAULT_FIELD_DECODER_NAME;
import static io.prestosql.plugin.kinesis.decoder.json.RFC2822JsonKinesisFieldDecoder.FORMATTER;
import static io.prestosql.plugin.kinesis.decoder.util.DecoderTestUtil.checkIsNull;
import static io.prestosql.plugin.kinesis.decoder.util.DecoderTestUtil.checkValue;

...
public class KinesisConnectorConfig
{
    ...
    /**
     * The name of dynamodb table to store the checkpoint information
     */

    private String checkpointDynamodbTable = "presto_kinesis_checkpoints";
    ...
    @Config("kinesis.checkpoint-dynamodb-table")
    public KinesisConnectorConfig setCheckpointDynamodbTable(String checkpointDynamodbTable)
    {
        this.checkpointDynamodbTable = checkpointDynamodbTable;
        return this;
    }

    public String getCheckpointDynamodbTable()
    {
        return checkpointDynamodbTable;
    }
}
